...
def main(stop):
    ...
    #No need to convert it to a list, because "in" works with strings
    allowed_friends = config['Settings']['allowedInvites'].get()
        ...
        if phase in [None, "Lobby"]:
            ...
            if invitations:
                for inv in invitations:
                    ...
                    if summoner_name in allowed_friends:
...
class SettingsPage(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.add_widget(Label(text="Friends that can invite you"))
        self.allowedInvites = TextInput(multiline=False, text=str(allowed_friends))
        self.add_widget(self.allowedInvites)
    ...
    def save_button(self, instance):
        ...
        invites = [{self.allowedInvites.text}]
        ...
        doc['Settings']['allowedInvites'] = invites.lower()
